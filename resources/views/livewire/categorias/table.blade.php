<div>
        ...
        <div class="mx-auto max-w-5xl pb-12 sm:px-6 lg:px-8">
            <div
                ...
                <div class="align-center flex h-10 justify-between">
                    ...
                    <x-primary-button wire:click="criarCategoria()">
                        Nova Categoria
                    </x-primary-button>
                </div>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-2">
                                <button wire:click="editarCategoria({{ $categoria->id }})"
                                    ...
                                    <div
                                        ...
                                        <svg class="h-5 w-5 text-gray-800 dark:text-white" viewBox="0 0 20 20" fill="none"
                            ...
                            <td class="px-6 py-2">
                                <div class="flex flex-col items-center justify-center gap-4 md:flex-row">
                                    <a class="w-fit rounded-md border border-slate-600 px-2 text-nowrap text-center shadow-lg hover:bg-slate-800 hover:text-gray-200 dark:bg-slate-800 dark:hover:bg-slate-900"
                                        href="{{ route('produtos.filtrar', $categoria) }}">Listar produtos</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
    ...
    <x-modal name="editar-categoria" :maxWidth="'md'" focusable>
        <livewire:categorias.edit-form :categoria="$categoriaSelecionada" key="{{ $categoriaSelecionada->id }}" />
    </x-modal>
</div>
