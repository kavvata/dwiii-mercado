<div>
                ...
                <table id="table-categoria" class="w-full table-fixed overflow-hidden">
                    ...
                    @foreach ($medidas as $medida)
                        <tr
                            ...
                            <td class="px-6 py-2">
                                <button wire:click="editarMedida({{ $medida->id }})"
    ...
    <x-modal name="editar-medida" :maxWidth="'md'" focusable>
        <livewire:unidade-medidas.edit-form :medida="$medidaSelecionada" key="{{ $medidaSelecionada->id }}" />
    </x-modal>
</div>
