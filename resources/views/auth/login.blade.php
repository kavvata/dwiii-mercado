<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex mt-4 justify-end gap-2">
            <button
                class="flex items-center bg-white dark:bg-gray-900 border border-slate-600 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white dark:hover:bg-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
